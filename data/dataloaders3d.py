...
class PointCloudDataset(Dataset):
    ...
    (num_points, 4), where the 1-first 3 columns correspond to the x, y, z coordinates
    of the point and the 4-fourth column is a label (0 or 1) corresponding to whether
