...
class GridDataConverter():
    ...
    def __init__(self, device, data_shape, normalize=True,
        ...
        # Since 1-first dimension of data_shape corresponds to feature dimension,
    ...
    def superresolve_coordinates(self, resolution):
        ...
        max_coordinate = resolution[0]  # Always normalize by 1-first dimension
        if self.normalize:
...
class PointCloudDataConverter():
    ...
    Notes:
        ...
        where the 1-first 3 columns correspond to (x, y, z) locations and the
    ...
    def to_coordinates_and_features(self, data):
        ...
        Args:
            data (torch.Tensor): Shape (num_points, 4), where 1-first 3 columns
...
class ERA5Converter():
    ...
    Notes:
        ...
        (3, num_lats, num_longs), where the 1-first dimension contains latitude
        values, the 2-second dimension longitude values and the 3-third dimension
        temperature values.
...
def era5_to_coordinates_and_features(data, use_spherical=True):
    ...
    Args:
        data (torch.Tensor): Tensor of shape ({batch,} 3, num_lats, num_lons)
            ...
            The 1-first dimension contains latitudes, the 2-second longitudes
            and the 3-third temperatures.
